...
-- Library functions 
    -- Misc functions
        ...
        function library:resolve_icon(icon)
            if type(icon) == "table" and icon.Url then
                return icon.Url, icon.ImageRectOffset, icon.ImageRectSize
            end
    ...
    -- Library element functions
        ...
        function library:tab(properties)
            ...
            local icon_image, icon_offset, icon_size = library:resolve_icon(cfg.icon)
            ...
            local items = cfg.items; do 
                ...
                -- Tab buttons 
                    ...
                    items[ "icon" ] = library:create( "ImageLabel" , {
                        ...
                        Parent = items[ "button" ];
                        AnchorPoint = vec2(0, 0.5);
                        Image = icon_image or cfg.icon;
                        ImageRectOffset = icon_offset or vec2(0, 0);
                        ImageRectSize = icon_size or vec2(0, 0);
                        BackgroundTransparency = 1;
